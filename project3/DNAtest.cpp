...
//
// Last Changed: February 23rd, 2023
...
//    }
    ...
    failed = false;
    for (size_t x = 0; (x < 50 * 2) && !failed; ++x) {
...
//            std::cout << "Test 63 FAIL. Expected -1 but received: " << std::endl;
//            failed = true;
//        }
//        if (dna1.cleave(x, "") != -1) {
...
//    }
    ...
    //Keep testing splice and cleave with null targets and sequences
    DNA_Strand dna46;
    DNA_Strand dna47;
    dna46.splice(6, "", "");
    dna46.splice("", "");
    dna46.cleave(98, "");
    dna46.cleave("");
    if (!dna46.isEqual(dna47)) {
        std::cout << "Test 85 FAIL" << std::endl;
    }
